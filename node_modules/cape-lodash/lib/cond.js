...
exports.condId = condId;
exports.overBranch = overBranch;

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function branch(bool, trueVal, falseVal) {
  return bool ? trueVal : falseVal;
}

// fpBranch(trueVal, falseVal, boolVal)
var fpBranch = exports.fpBranch = (0, _curry3.default)((0, _rearg3.default)(branch, [2, 0, 1]), 3);
// ternary
function condId() {
  ...
  var rules = (0, _concat3.default)(conditions, [[_stubTrue3.default, _identity3.default]]);
  return (0, _cond3.default)(rules);
}
function overBranch(boolCheck, getTrue) {
  var getFalse = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _identity3.default;

  return (0, _cond3.default)([[boolCheck, getTrue], [_stubTrue3.default, getFalse]]);
}